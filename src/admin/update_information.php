...
<?php
    ...
    $connect = Connect();
    $var = "select * from mis.user_info where username='marclawrence';";
    $result = $connect->query($var);
?>
<html>
    <head>
                ...
                <div>
                    ...
                    <div class="row">
                        <div class="form-group col-4">
                            ...
                            <br>
              		        <input type="text"  class="form-control" value="<?php $row = $result->fetch_assoc();echo $row["birthdate"];?>">
              		    </div>

                        <div class="form-group col-4" >
                            <label for="pbirth">Place of Birth</label>
                            <br>
              		        <input type="text" class="form-control" value="<?php echo $row["birth_place"];?>">
                        </div>
    ...
    <script type="text/javascript" src="../cript/ajax.js"></script>
    </body>
</html>
