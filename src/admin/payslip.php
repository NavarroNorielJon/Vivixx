						...
						<div class="container-fluid">
							<form action="">
								...
								<div class="row border-bottom">
									...
									<div class="col-2 p-0">
										<input type="text" class="form-control form-control-sm bg-dark text-white rounded-0" name="basic-salary">
									</div>
									<label for="daily-rate" class="col-2 p-0">&#9658; Daily Rate</label>
									<div class="col-2 p-0">
										<input type="text" class="form-control form-control-sm bg-dark text-white rounded-0" name="daily-rate">
									</div>
									<label for="hourly-rate" class="col-2 p-0">&#9658; Hourly Rate</label>
									<div class="col-2 p-0">
										<input type="text" class="form-control form-control-sm bg-dark text-white rounded-0" name="hourly-rate">
									</div>
								</div>
								<div class="row border-bottom">
									<div class="col-2"></div>
								...
								<div class="row border-bottom">
									...
									<div class="col-6">
										<div class="row">
											<div class="col-3 p-0">
												<input type="text" class="form-control form-control-sm rounded-0" name="basic-salary">
											</div>
											<div class="col-3 text-center"> X</div>
											<div class="col-3 p-0">
												<input type="text" class="form-control form-control-sm rounded-0" name="basic-salary-days">
											</div>
									...
									<div class="col-4">
										<div class="row">
											<div class="col-1"> =</div>
											<div class="col-5">
												<input type="text" class="form-control form-control-sm rounded-0" name="basic-salary-total" disabled></div>
										</div>
									</div>
								</div>
								<div class="row border-bottom">
								...
								<div class="row border-bottom">
									...
									<div class="col-6">
										<div class="row">
											<div class="col-3 p-0">
												<input type="text" class="form-control form-control-sm rounded-0" name="night-differential">
											</div>
											<div class="col-3 text-center"> X</div>
											<div class="col-3 p-0">
												<input type="text" class="form-control form-control-sm rounded-0" name="night-differential-days">
											</div>
											<div class="col-3">days</div>
										</div>
									</div>
									<div class="col-4">
										<div class="row">
											<div class="col-1"> =</div>
											<div class="col-5">
												<input type="text" class="form-control form-control-sm rounded-0" name="night-differential-days" disabled></div>
										</div>
									</div>
								</div>
								<div class="row border-bottom">
								...
								<div class="row border-bottom">
									...
									<div class="col-6">
										<div class="row">
											<div class="col-3 p-0">
												<input type="text" class="form-control form-control-sm rounded-0" name="overtime-pay">
											</div>
											<div class="col-3 text-center"> X</div>
											<div class="col-3 p-0">
												<input type="text" class="form-control form-control-sm rounded-0" name="overtime-pay-days">
											</div>
											<div class="col-3">days</div>
										</div>
									</div>
									<div class="col-4">
										<div class="row">
											<div class="col-1"> =</div>
											<div class="col-5">
												<input type="text" class="form-control form-control-sm rounded-0" name="overtime-pay-total" disabled></div>
										</div>
									</div>
								</div>
								<div class="row border-bottom">
								...
								<div class="row border-bottom">
									...
									<div class="col-6">
										<div class="row">
											<div class="col-3 p-0">
												<input type="text" class="form-control form-control-sm rounded-0" name="holiday-pay">
											</div>
											<div class="col-3 text-center"> X</div>
											<div class="col-3 p-0">
												<input type="text" class="form-control form-control-sm rounded-0" name="holiday-pay-days">
											</div>
											<div class="col-3">days</div>
										</div>
									</div>
									<div class="col-4">
										<div class="row">
											<div class="col-1"> =</div>
											<div class="col-5">
												<input type="text" class="form-control form-control-sm rounded-0" name="holiday-pay-total" disabled></div>
										</div>
									</div>
								</div>
								<div class="row border-bottom">
								...
								<div class="row border-bottom">
									...
									<div class="col-4">
										<div class="row">
											<div class="col-1"> =</div>
											<div class="col-5">
												<input type="text" class="form-control form-control-sm rounded-0" name="transportation-allowance"></div>
										</div>
									</div>
								</div>
								<div class="row border-bottom">
									...
									<div class="col-4">
										<div class="row">
											<div class="col-1"> =</div>
											<div class="col-5">
												<input type="text" class="form-control form-control-sm rounded-0" name="meal-allowance"></div>
										</div>
									</div>
								</div>
								<div class="row border-bottom">
									...
									<div class="col-4">
										<div class="row">
											<div class="col-1"> =</div>
											<div class="col-5">
												<input type="text" class="form-control form-control-sm rounded-0" name="communications-allowance"></div>
										</div>
									</div>
								</div>
								<div class="row border-bottom">
									...
									<div class="col-4">
										<div class="row">
											<div class="col-1"> =</div>
											<div class="col-5">
												<input type="text" class="form-control form-control-sm rounded-0" name="clothing-allowance"></div>
										</div>
									</div>
								</div>
								<div class="row border-bottom">
									...
									<div class="col-4">
										<div class="row">
											<div class="col-1"> =</div>
											<div class="col-5">
												<input type="text" class="form-control form-control-sm rounded-0" name="attendance-incentive"></div>
										</div>
									</div>
								</div>
								<div class="row border-bottom p-0">
									...
									<div class="col-4">
										<div class="row p-0">
											<div class="col-1"> =</div>
											<div class="col-5">
												<input type="text" class="form-control form-control-sm rounded-0" name="medical-allowance"></div>
											<div class="col-5 p-0">
								...
								<div class="row border-bottom">
									...
									<div class="col-4">
										<div class="row">
											<div class="col-1"> =</div>
											<div class="col-5">
												<input type="text" class="form-control form-control-sm rounded-0" name="fifteenth-of-the-month"></div>
										</div>
									</div>
								</div>
								<div class="row border-bottom">
									...
									<div class="col-4">
										<div class="row">
											<div class="col-1"> =</div>
											<div class="col-5">
												<input type="text" class="form-control form-control-sm rounded-0" name="W/H-tax-deduction"></div>
										</div>
									</div>
								</div>
								<div class="row border-bottom">
									...
									<div class="col-4">
										<div class="row">
											<div class="col-1"> =</div>
											<div class="col-5">
												<input type="text" class="form-control form-control-sm rounded-0" name="sss"></div>
										</div>
									</div>
								</div>
								<div class="row border-bottom">
									...
									<div class="col-4">
										<div class="row">
											<div class="col-1"> =</div>
											<div class="col-5">
												<input type="text" class="form-control form-control-sm rounded-0" name="PHIC"></div>
										</div>
									</div>
								</div>
								<div class="row border-bottom">
									...
									<div class="col-4">
										<div class="row">
											<div class="col-1"> =</div>
											<div class="col-5">
												<input type="text" class="form-control form-control-sm rounded-0" name="hmdf"></div>
										</div>
									</div>
								</div>
								<div class="row border-bottom p-0">
									...
									<div class="col-4">
										<div class="row p-0">
											<div class="col-1"> =</div>
											<div class="col-5">
												<input type="text" class="form-control form-control-sm rounded-0" name="cash-advances"></div>
										</div>
									</div>
								</div>
								<div class="row border-bottom p-0">
									...
									<div class="col-4">
										<div class="row p-0">
											<div class="col-1"> =</div>
											<div class="col-5">
												<input type="text" class="form-control form-control-sm rounded-0" name="salary-loan"></div>
											<div class="col-5 p-0">
												<input type="text" class="form-control form-control-sm rounded-0 bg-dark
