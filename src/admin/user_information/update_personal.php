<?php
    ...
    if (!empty($_FILES['prof_image']['tmp_name'])) {
    ...
    if (!empty($_FILES['prof_image']['tmp_name']) && empty($_FILES['signature']['tmp_name'])) {
    ...
    } elseif (!empty($_FILES['signature']['tmp_name'])  && empty($_FILES['prof_image']['tmp_name'])) {
