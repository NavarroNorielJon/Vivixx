                ...
                <div class="form-group">
                  ...
                  <label for="pass">Password</label>
                    ...
                    <label for="cpass">Confirm Password</label>
        				    <input type="password" name="confirm_password" id="cpass" onclick="next('next','password','cpass')" onkeyup="confirmPass('confirm_password',this.value,'password','validConfirmation')" class="form-control" required="required">
